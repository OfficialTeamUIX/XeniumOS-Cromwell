...
static void SetTVConexantRegister(const TV_MODE_PARAMETER* mode, const BLANKING_PARAMETER* blanks, BYTE* pbRegs)
{
	...
	I2CWriteBytetoRegister(0x45, 0xFC, 0x00);
	if (mode->nVideoStd == NTSC)
	{
		I2CWriteBytetoRegister(0x45, 0xF2, 0x00);
		I2CWriteBytetoRegister(0x45, 0xF4, 0x66);
		I2CWriteBytetoRegister(0x45, 0xF6, 0xB5);
		I2CWriteBytetoRegister(0x45, 0xF8, 0xB2);
		I2CWriteBytetoRegister(0x45, 0xFA, 0x7D);
	}
	I2CWriteBytetoRegister(0x45, 0xFC, 0x00);
